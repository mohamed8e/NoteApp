...
import com.hussein.startup.NoteDatabase
...
class MyNotes : Fragment() {
    ...
    var dbManager: NoteDatabase? = null
    ...
    fun loadQuery(title:String):ArrayList<Note>{
        return dbManager!!.NoteDao().loadByTitle(title) as ArrayList<Note>
    ...
    inner class  MyNotesAdpater: BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            myView.ivDelete.setOnClickListener{
                ...
                dbManager!!.NoteDao().delet(myNote)
                loadQuery("%")
            }
